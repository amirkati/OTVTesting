...
#define DCM_MOTOR_SPEED_A 80
#define DCM_MOTOR_SPEED_B 80
// or do 60 
...
void move(double distance)
{
  ...
  if(distance<0) {
    set_dc_motor(DCM_MOTOR1, DCM_DIR_BACKWARD, DCM_MOTOR_SPEED_A);
    set_dc_motor(DCM_MOTOR2, DCM_DIR_BACKWARD, DCM_MOTOR_SPEED_B);
    }
...
// fabs() is absolute value for floating point numbers (real numbers that the computer stores) (like double or float) 
  ...
  set_dc_motor(DCM_MOTOR1, DCM_DIR_OFF, DCM_MOTOR_SPEED_A);
  set_dc_motor(DCM_MOTOR2, DCM_DIR_OFF, DCM_MOTOR_SPEED_B);
...
// IMU isn't used or is inside a part 
